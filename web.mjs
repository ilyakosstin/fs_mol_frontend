...
;
	($.$bog_tox_fs_home) = class $bog_tox_fs_home extends ($.$mol_list) {
		Header(){
			const obj = new this.$.$mol_text();
			(obj.text) = () => ("The TOX File Service");
			return obj;
		}
		auth_rows(){
			return [];
		...
		FileDirectoryList(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ((this.file_directories()));
			return obj;
		}
		auth_label(){
			return "";
	...
	($mol_mem(($.$bog_tox_fs_home.prototype), "Auth_label"));
	($mol_mem(($.$bog_tox_fs_home.prototype), "Login"));
	($mol_mem(($.$bog_tox_fs_home.prototype), "Logout"));
...
(function ($) {
    ...
    // когда с $ и когда без 
    function tox_resolve_test() {
        return $mol_fetch.json(`${SELF_BASE_URI()}/test`);
    }
    $.tox_resolve_test = tox_resolve_test;
    function SELF_BASE_URI() {
        return 'http://localhost:9080';
    }
    $.SELF_BASE_URI = SELF_BASE_URI;
    function AUTH_BASE_URI() {
        return 'http://auth.local.test:9000';
    }
    $.AUTH_BASE_URI = AUTH_BASE_URI;
    function FS_BASE_URI() {
        return 'http://fs.local.test:8000';
    }
    $.FS_BASE_URI = FS_BASE_URI;
})($ || ($ = {}));
...
(function ($) {
    ...
    function $mol_jwt_decode(raw) {
        let line = 'split';
        try {
            const [headers_raw, payload_raw] = raw.split('.');
            if (!payload_raw)
                throw new Error(`No second chunk, splitted by "." in token`);
            line = 'decode payload';
...
(function ($) {
    ...
    class $bog_tox_fs_tox_oauth2 extends $mol_object2 {
        ...
        // --- хранилище ---
        stored(next) {
            return this.$.$mol_state_local.value(this.store_key(), next);
        }
        // --- разбор токена ---
        payload(token) {
            try {
                return this.$.$mol_jwt_decode(token).payload;
            }
            catch (error) {
                if ($mol_promise_like(error))
                    $mol_fail_hidden(error);
        ...
        fetch_by_refresh(refresh_token) {
        ...
        tokens() {
            ...
            if (!stored)
                return null;
            if (!this.expired(stored.access_token))
                return stored;
            try {
    ...
    __decorate([
        $mol_mem
    ], $bog_tox_fs_tox_oauth2.prototype, "code", null);
    __decorate([
        $mol_mem
    ], $bog_tox_fs_tox_oauth2.prototype, "stored", null);
    __decorate([
        $mol_action
    ], $bog_tox_fs_tox_oauth2.prototype, "fetch_tokens", null);
    __decorate([
        $mol_action
    ], $bog_tox_fs_tox_oauth2.prototype, "fetch_by_refresh", null);
    __decorate([
        $mol_action
    ], $bog_tox_fs_tox_oauth2.prototype, "fetch_by_code", null);
    __decorate([
        $mol_mem
    ], $bog_tox_fs_tox_oauth2.prototype, "tokens", null);
    __decorate([
        $mol_action
    ], $bog_tox_fs_tox_oauth2.prototype, "login", null);
    __decorate([
        $mol_action
    ], $bog_tox_fs_tox_oauth2.prototype, "logout", null);
    __decorate([
        $mol_action
    ], $bog_tox_fs_tox_oauth2.prototype, "exchange", null);
    $.$bog_tox_fs_tox_oauth2 = $bog_tox_fs_tox_oauth2;
})($ || ($ = {}));
...
var $;
(function ($) {
    class $bog_tox_fs_tox_fs extends $mol_object2 {
    ...
    __decorate([
        $mol_mem
    ], $bog_tox_fs_tox_fs.prototype, "directories", null);
    $.$bog_tox_fs_tox_fs = $bog_tox_fs_tox_fs;
})($ || ($ = {}));

;
	($.$bog_tox_fs_home_directory) = class $bog_tox_fs_home_directory extends ($.$mol_view) {
		Index(){
			const obj = new this.$.$mol_text();
			(obj.text) = () => ((this.index()));
			return obj;
	...
	($mol_mem(($.$bog_tox_fs_home_directory.prototype), "Index"));
	($mol_mem(($.$bog_tox_fs_home_directory.prototype), "DisplayedName"));
	($mol_mem(($.$bog_tox_fs_home_directory.prototype), "AdditionalInfo"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_tox_fs_home_directory extends $.$bog_tox_fs_home_directory {
            data() {
                return this.dto();
            }
            displayed_name() {
        ...
        $$.$bog_tox_fs_home_directory = $bog_tox_fs_home_directory;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_tox_fs_home extends $.$bog_tox_fs_home {
            session() { return this.$.$mol_one.$bog_tox_fs_tox_oauth2; }
        ...
        __decorate([
            $mol_action
        ], $bog_tox_fs_home.prototype, "login", null);
        __decorate([
            $mol_action
        ], $bog_tox_fs_home.prototype, "logout", null);
        __decorate([
            $mol_mem
        ], $bog_tox_fs_home.prototype, "directories_data", null);
        __decorate([
            $mol_mem_key
        ], $bog_tox_fs_home.prototype, "Directory", null);
        __decorate([
            $mol_mem
        ], $bog_tox_fs_home.prototype, "file_directories", null);
        $$.$bog_tox_fs_home = $bog_tox_fs_home;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_tox_fs_oauth2_callback) = class $bog_tox_fs_oauth2_callback extends ($.$mol_page) {
		wait_label(){
			return "Give us one moment...";
		}
		code(){
			return "<code>";
		}
		...
		Token(){
			...
			(obj.title) = () => ("Get access & refresh tokens");
			(obj.click) = (next) => ((this.token(next)));
			return obj;
		}
		sub(){
			return [
	...
	($mol_mem(($.$bog_tox_fs_oauth2_callback.prototype), "token"));
	($mol_mem(($.$bog_tox_fs_oauth2_callback.prototype), "Token"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_tox_fs_oauth2_callback extends $.$bog_tox_fs_oauth2_callback {
            session() { return this.$.$mol_one.$bog_tox_fs_tox_oauth2; }
        ...
        __decorate([
            $mol_action
        ], $bog_tox_fs_oauth2_callback.prototype, "token", null);
        $$.$bog_tox_fs_oauth2_callback = $bog_tox_fs_oauth2_callback;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));

;
	($.$bog_tox_fs_oauth2_status) = class $bog_tox_fs_oauth2_status extends ($.$mol_page) {
		access_token(){
			return "Access token";
		}
		refresh_token(){
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_tox_fs_oauth2_status extends $.$bog_tox_fs_oauth2_status {
            session() { return this.$.$mol_one.$bog_tox_fs_tox_oauth2; }
            access_token() {
        ...
        $$.$bog_tox_fs_oauth2_status = $bog_tox_fs_oauth2_status;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_tox_fs_local) = class $bog_tox_fs_local extends ($.$mol_page) {
		code_local(next){
			if(next !== undefined) return next;
			return "";
		}
		Code_local(){
			...
			(obj.value) = (next) => ((this.code_local(next)));
			return obj;
		}
		code_query(next){
			if(next !== undefined) return next;
		...
		Code_query(){
			const obj = new this.$.$mol_string();
			(obj.value) = (next) => ((this.code_query(next)));
			return obj;
		}
		sub(){
			return [(this.Code_local()), (this.Code_query())];
		}
	};
	($mol_mem(($.$bog_tox_fs_local.prototype), "code_local"));
	($mol_mem(($.$bog_tox_fs_local.prototype), "Code_local"));
	($mol_mem(($.$bog_tox_fs_local.prototype), "code_query"));
	($mol_mem(($.$bog_tox_fs_local.prototype), "Code_query"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_tox_fs_local extends $.$bog_tox_fs_local {
            code_local(next) {
                if (next === undefined) {
        ...
        __decorate([
            $mol_mem
        ], $bog_tox_fs_local.prototype, "code_local", null);
        __decorate([
            $mol_mem
        ], $bog_tox_fs_local.prototype, "code_query", null);
        $$.$bog_tox_fs_local = $bog_tox_fs_local;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_tox_fs_app) = class $bog_tox_fs_app extends ($.$mol_book2) {
		...
		Home(){
			const obj = new this.$.$bog_tox_fs_home();
			return obj;
		}
		Callback(){
			const obj = new this.$.$bog_tox_fs_oauth2_callback();
			return obj;
		}
		Status(){
			const obj = new this.$.$bog_tox_fs_oauth2_status();
			return obj;
		}
		Local(){
	...
	($mol_mem(($.$bog_tox_fs_app.prototype), "Theme"));
	($mol_mem(($.$bog_tox_fs_app.prototype), "Home"));
