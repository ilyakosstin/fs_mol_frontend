...
declare namespace $ {
     ...
     */
    let $mol_gap: Record<"text" | "block" | "blur" | "space" | "page" | "round" | "emoji", $mol_style_func<"var", unknown>>;
}
...
declare namespace $ {
    ...
    function tox_resolve_test(): $TestDto;
    function SELF_BASE_URI(): string;
    function AUTH_BASE_URI(): string;
    function FS_BASE_URI(): string;
}
...
declare namespace $ {
    ...
    export class $bog_tox_fs_tox_oauth2 extends $mol_object2 {
        ...
        min_validity(): number;
        store_key(): string;
        endpoint(key: 'auth' | 'token'): string;
        /**
        ...
        code(): string;
        stored(next?: $bog_tox_fs_tox_oauth2_tokens | null): $bog_tox_fs_tox_oauth2_tokens | null;
        ...
        parse(response: $mol_fetch_response): Record<string, string> | null;
        fetch_tokens(fd: URLSearchParams): $bog_tox_fs_tox_oauth2_tokens;
        fetch_by_refresh(refresh_token: string): $bog_tox_fs_tox_oauth2_tokens;
        fetch_by_code(code: string): $bog_tox_fs_tox_oauth2_tokens;
        ...
        login(): void;
        logout(): void;
        exchange(code: string): $bog_tox_fs_tox_oauth2_tokens | null;
    }
    export {};
}

declare namespace $ {
    type $bog_tox_fs_tox_fs_directory = {
        id: string;
        ownerId: string;
        name: string | null;
        isPublic: boolean;
    ...
    class $bog_tox_fs_tox_fs extends $mol_object2 {
        ...
        directories(): $bog_tox_fs_tox_fs_directory[];
...
declare namespace $ {
	...
	type $mol_text__text_bog_tox_fs_home_directory_1 = $mol_type_enforce<
		ReturnType< $bog_tox_fs_home_directory['index'] >
		,
		ReturnType< $mol_text['text'] >
	>
	type $mol_link__title_bog_tox_fs_home_directory_2 = $mol_type_enforce<
		ReturnType< $bog_tox_fs_home_directory['displayed_name'] >
		,
		ReturnType< $mol_link['title'] >
	>
	type $mol_link__uri_bog_tox_fs_home_directory_3 = $mol_type_enforce<
		ReturnType< $bog_tox_fs_home_directory['link_uri'] >
		,
		ReturnType< $mol_link['uri'] >
	>
	type $mol_text__text_bog_tox_fs_home_directory_4 = $mol_type_enforce<
		ReturnType< $bog_tox_fs_home_directory['additional_info'] >
		,
		ReturnType< $mol_text['text'] >
	>
	export class $bog_tox_fs_home_directory extends $mol_view {
		Index( ): $mol_text
		displayed_name( ): string
		link_uri( ): string
		DisplayedName( ): $mol_link
		additional_info( ): string
		AdditionalInfo( ): $mol_text
		dto( ): any
		index( ): string
		sub( ): readonly(any)[]
	}
...
declare namespace $.$$ {
    class $bog_tox_fs_home_directory extends $.$bog_tox_fs_home_directory {
        data(): $bog_tox_fs_tox_fs_directory;
        displayed_name(): string;
        link_uri(): string;
        additional_info(): string;
    }
...
declare namespace $ {
	...
	type $mol_text__text_bog_tox_fs_home_1 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_text['text'] >
	>
	type $mol_list__rows_bog_tox_fs_home_2 = $mol_type_enforce<
		ReturnType< $bog_tox_fs_home['auth_rows'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	...
	type $mol_button_minor__click_bog_tox_fs_home_8 = $mol_type_enforce<
		...
		ReturnType< $mol_button_minor['click'] >
	>
	export class $bog_tox_fs_home extends $mol_list {
		Header( ): $mol_text
...
declare namespace $.$$ {
    class $bog_tox_fs_home extends $.$bog_tox_fs_home {
        session(): $bog_tox_fs_tox_oauth2;
        files(): $bog_tox_fs_tox_fs;
        auth_label(): string;
        auth_rows(): ($mol_button_minor | $.$mol_text)[];
        login(): void;
        logout(next?: any): void;
        directories_data(): $bog_tox_fs_tox_fs_directory[];
        /** Ключ переживает перерисовку — строка не пересоздаётся. */
        Directory(index: number): $bog_tox_fs_home_directory;
        file_directories(): $bog_tox_fs_home_directory[];
    }
}
...
declare namespace $ {
	...
	type $mol_button_major__title_bog_tox_fs_oauth2_callback_1 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_major['title'] >
	>
	type $mol_button_major__click_bog_tox_fs_oauth2_callback_2 = $mol_type_enforce<
		ReturnType< $bog_tox_fs_oauth2_callback['token'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	export class $bog_tox_fs_oauth2_callback extends $mol_page {
		wait_label( ): string
		code( ): string
		token( next?: any ): any
		Token( ): $mol_button_major
		sub( ): readonly(any)[]
	}
...
declare namespace $ {
	...
	export class $bog_tox_fs_oauth2_status extends $mol_page {
		access_token( ): string
		refresh_token( ): string
		user_data( ): string
		sub( ): readonly(any)[]
...
declare namespace $ {
	...
	type $mol_string__value_bog_tox_fs_local_1 = $mol_type_enforce<
		ReturnType< $bog_tox_fs_local['code_local'] >
		,
		ReturnType< $mol_string['value'] >
	>
	type $mol_string__value_bog_tox_fs_local_2 = $mol_type_enforce<
		ReturnType< $bog_tox_fs_local['code_query'] >
		,
		ReturnType< $mol_string['value'] >
	>
	export class $bog_tox_fs_local extends $mol_page {
		code_local( next?: string ): string
		Code_local( ): $mol_string
		code_query( next?: string ): string
		Code_query( ): $mol_string
		sub( ): readonly(any)[]
	}
